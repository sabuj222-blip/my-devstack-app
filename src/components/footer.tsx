...
export const Footer = () => {
    return (
        <footer className="w-full bg-white border-t border-gray-100 mt-12 md:mt-20 pt-10 md:pt-16 pb-8">
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 pb-10 md:pb-12 text-center sm:text-left">
                    <div className="sm:col-span-2 md:col-span-2 space-y-4 flex flex-col items-center sm:items-start">
                        <div className="flex items-center gap-2">
                            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-pink-500 font-bold text-white text-xs">
                                DS
                            </div>
                        ...
                        <div className="flex items-center gap-4 pt-2 text-sm font-medium text-slate-600 justify-center sm:justify-start">
                ...
                <div className="border-t border-gray-100 pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-400 gap-4 text-center sm:text-left">

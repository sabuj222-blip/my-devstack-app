      ...
      <div className="relative flex items-center justify-between px-4 sm:px-8 py-4 mx-auto max-w-6xl">
        <div className="flex md:hidden items-center">
          <button
            ...
            className="p-1 text-gray-700 hover:text-pink-600 focus:outline-none"
        ...
        <div className="flex items-center gap-1.5 sm:gap-3">
          <button className="px-2.5 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-base font-medium text-gray-700 transition-colors hover:text-pink-600">
            Sign In
          </button>
          <button className="px-3 sm:px-5 py-1.5 sm:py-2 text-xs sm:text-base font-medium text-white transition-colors bg-pink-600 rounded-lg hover:bg-pink-700">
            Sign Up
          </button>
        </div>
      </div>
      {isOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white px-8 py-4 flex flex-col gap-4 font-medium text-gray-700 shadow-lg">
          <a
            href="#home"
